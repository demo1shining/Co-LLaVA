...
def eval_model(args):
    ...
    for i in tqdm(range(0,len(questions),args.batch_size)):
        ...
        image_tensor_batch = image_processor.preprocess(image_folder,crop_size ={'height': 512, 'width': 512},size = {'shortest_edge': 512}, return_tensors='pt')['pixel_values']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/data/Instruct_tuning/GeoChat/checkpoint/lora/geochat_LR_HR10_full")
    parser.add_argument("--model-base", type=str, default=None)
    parser.add_argument("--image-folder", type=str, default="/data/user3/gzqy/CoCaVQA/RSVQA_Images/Images_LR_tif/")
    parser.add_argument("--question-file", type=str, default="/data/Instruct_tuning/GeoChat/TEST/test_data/LR_test_images_pro.jsonl")
    parser.add_argument("--answers-file", type=str, default="/data/Instruct_tuning/GeoChat/TEST/result_data/LR_cLRHR10full1111.jsonl")
